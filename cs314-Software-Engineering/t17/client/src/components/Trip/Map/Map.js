...
export default function Map(props) {
    ...
    return (
        ...
        >
            ...
            <PlaceMarker places={props.places} selectedIndex={props.selectedIndex} distances={props.distances} />
        </LeafletMap>
    );
}
...
function PlaceMarker({places, selectedIndex, distances}) {
    if (selectedIndex === -1) {
        return null;
    }
    ...
    return <Marker place={places[selectedIndex]} distances={distances[selectedIndex]} />;
}