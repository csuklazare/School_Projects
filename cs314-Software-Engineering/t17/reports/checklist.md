...
* Are we trying to access a value that hasn't been initialized yet?
* Are we receiving a null pointer exception? Have we made sure all values are initialized upon rendering?
...
* Are we passing all of the necessary parameters to the function?
* Are we using the correct variables in each function?
